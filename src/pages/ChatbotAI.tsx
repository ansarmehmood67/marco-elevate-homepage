            ...
            <div className="space-y-16">
              {[
                ...
                },
                {
                  ...
                  description: "Lo distribuiamo sulla piattaforma scelta (sito web, WhatsApp, Facebook Messenger, ecc.) con test completi.",
                  benefit: "Integrazione perfetta multicanale",
                  icon: TrendingUp
                },
                {
                  number: "04",
                  title: "Optimization & Scaling",
                  description: "Monitoriamo le performance, ottimizziamo le risposte e espandiamo le funzionalità per massimizzare i risultati.",
                  benefit: "Performance continue e migliorate",
                  icon: ArrowRight
                }
              ].map((phase, index) => {
