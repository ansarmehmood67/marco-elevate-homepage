        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center space-y-12">
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#2E8BC0]/10 to-[#87CEEB]/10 rounded-full border border-[#2E8BC0]/20 backdrop-blur-sm">
              ...
              <span className="text-[#2E8BC0] font-semibold text-sm">Monetizza YouTube</span>
            </div>
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-2xl text-slate-600 font-medium max-w-4xl mx-auto leading-relaxed">
                Strategie avanzate per{" "}
                <span className="text-[#2E8BC0] font-semibold">monetizzare il tuo canale YouTube</span> 
                e trasformarlo in una macchina per generare lead e vendite.
              </p>
            </div>
          ...
          <div className="space-y-8">
            <blockquote className="space-y-6">
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                Trasforma i tuoi contenuti video in un funnel di vendita automatizzato e altamente performante
              </p>
            </blockquote>
          </div>
        </div>
