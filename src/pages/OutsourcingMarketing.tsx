  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 sm:pt-24 lg:pt-24 pb-16 px-0 bg-black relative overflow-hidden min-h-screen">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="relative min-h-[85vh] rounded-3xl overflow-hidden bg-black border border-gray-800/30 shadow-2xl">
            ...
            >
              <source src="https://pub-220eaee26a544ef2977155a11f057e5a.r2.dev/outsourced%20markteting%20hero.mp4" type="video/mp4" />
            </video>
      ...
      <section className="py-40 relative overflow-hidden">
        ...
        >
          <source src="https://pub-220eaee26a544ef2977155a11f057e5a.r2.dev/outsourced%20markteting%20page.mp4" type="video/mp4" />
        </video>
