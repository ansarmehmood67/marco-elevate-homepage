        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="relative rounded-3xl overflow-hidden border border-gray-800/30 shadow-2xl bg-black/60 backdrop-blur-sm lg:min-h-[80vh]">
            ...
            <div className="absolute inset-0 z-10 pointer-events-none">
              <div className="absolute left-1/2 transform translate-x-6 sm:translate-x-10 lg:translate-x-14 xl:translate-x-18 bottom-0 w-56 sm:w-72 lg:w-96 xl:w-[420px] h-auto">
                <img 
                  src={marcoHeroImage}
                  alt="Marco Ferrario"
                  className="w-full h-auto opacity-60 sm:opacity-100 lg:opacity-100"
                />
