      ...
      <section className="pt-24 sm:pt-24 lg:pt-24 pb-16 px-0 transition-all duration-500 relative overflow-hidden bg-black min-h-screen">
        <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="relative min-h-[85vh] lg:min-h-[90vh] rounded-3xl overflow-hidden transition-all duration-500 shadow-2xl bg-black border border-gray-800/30">
            ...
            {/* Enhanced Content */}
            <div ref={ref} className="relative lg:absolute lg:inset-0 flex flex-col justify-center lg:justify-center p-4 sm:p-6 lg:p-12 pt-6 sm:pt-10 lg:pt-12 pb-10 sm:pb-12 lg:pb-12 z-20">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-24">
            ...
            <p className="text-xl lg:text-2xl leading-relaxed text-white/90 max-w-3xl mx-auto">
              Ogni azienda è diversa, ma il nostro approccio è sempre lo stesso: semplice, concreto e orientato ai risultati. Con un Direttore Vendite a noleggio al tuo fianco, in tre step chiari passiamo dall'analisi alla strategia fino all'esecuzione, per garantirti <span className="font-bold text-white">miglioramenti reali e misurabili</span>.
            </p>
          </div>
