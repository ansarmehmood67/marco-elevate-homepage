          ...
          >
            ...
            <div className="absolute bottom-12 left-12 max-w-2xl">
              ...
              <p className="text-xl lg:text-2xl text-gray-100 mb-8 font-light leading-relaxed max-w-2xl">
                Gestione professionale delle chiamate con <span className="font-semibold text-blue-200">operatori qualificati</span> e supporto multicanale.
              </p>
