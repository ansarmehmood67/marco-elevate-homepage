...
const SimpleHero = () => {
  return (
    <section className="pt-24 pb-16 px-0 bg-black relative overflow-hidden min-h-screen">
      {/* Simple background */}
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative rounded-3xl overflow-hidden border border-gray-800/30 shadow-2xl bg-black/60 backdrop-blur-sm min-h-[85vh] lg:min-h-[90vh]">
          ...
          <div className="absolute inset-0">
            <img
              src="https://res.cloudinary.com/dsergeqc9/image/upload/c_scale,w_1920,q_85/v1758129785/homepage_hero_poster.jpg"
          ...
          {/* Content */}
          <div className="relative lg:absolute lg:inset-0 flex flex-col justify-center lg:justify-center p-2 sm:p-2 lg:p-6 pt-6 sm:pt-10 lg:pt-4 pb-4 sm:pb-6 lg:pb-4 z-20">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 sm:gap-6 lg:gap-8">
              
              {/* Left content */}
              <div className="flex-1 max-w-5xl">
                <h1 className="text-hero-title font-black leading-constrained-tight tracking-tight text-white mb-2 text-center lg:text-left">
                ...
                <div className="mb-6 lg:mb-10">
                  <div className="relative inline-block">
                    <p className="inline-block w-fit max-w-[60ch] text-hero-body text-white/95 leading-constrained-relaxed backdrop-blur-xl bg-gradient-to-r from-black/30 via-black/20 to-black/30 rounded-2xl px-4 lg:px-2 py-1 lg:py-2 border border-white/10 shadow-2xl">
                      ...
                      <span className="text-primary font-medium">vendite</span>
                      , accelera i{" "}
                      <span className="text-primary font-medium">risultati</span>
                ...
                <div className="relative group mb-8 sm:mb-0 flex justify-center lg:justify-start">
                  <a href="#contact" className="w-fit">
                    <Button className="relative font-bold px-8 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 text-base sm:text-lg lg:text-xl rounded-full shadow-2xl transition-all duration-700 bg-gradient-to-r from-white via-gray-50 to-white text-black border-2 border-white/60 backdrop-blur-xl overflow-hidden group hover:shadow-[0_0_50px_hsl(var(--primary-glow)/0.4)] transform lg:hover:scale-105 hover:-translate-y-0.5 hover:from-primary hover:via-primary-glow hover:to-primary hover:text-white hover:border-primary/70">
                      <span className="flex items-center space-x-2 lg:space-x-3 relative z-10">
                        <span className="relative">
                          Inizia subito
                        </span>
                        <ArrowRight className="w-4 h-4 lg:w-5 lg:h-5 transition-all duration-500 group-hover:translate-x-3 group-hover:text-white animate-pulse" />
                      </span>
                    </Button>
                  </a>
                </div>
              ...
              <div className="w-full sm:w-80 lg:w-80 lg:flex-shrink-0 group">
                <div className="relative">
                  <div className="w-full h-44 sm:h-48 rounded-2xl overflow-hidden shadow-2xl border border-white/40 backdrop-blur-xl bg-gradient-to-br from-black/30 via-black/20 to-black/30 transition-all duration-700 lg:hover:shadow-[0_0_40px_rgba(56,189,248,0.3)] lg:hover:scale-105">
                    <LazyYouTubeEmbed
                      videoId="ZocHP6N9Aig"
