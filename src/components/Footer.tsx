      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <img src="https://res.cloudinary.com/dc1zzgsjw/image/upload/v1758145901/sales_3_baw70d.png" alt="Marco Ferrario - Sales On Demand Logo" width="120" height="48" style={{ aspectRatio: '2.5/1' }} className="h-12 w-auto" loading="lazy" decoding="async" />
              <p className="text-gray-300 text-sm leading-relaxed">
                Trasformiamo le aziende attraverso strategie di vendita innovative e automazione intelligente.
              </p>
            </div>
            <div className="flex space-x-4">
              <a href="#" className="group p-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-primary/50 transition-all duration-300">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 text-sm">
              <p className="flex items-center">
                ...
                <a href="mailto:info@marco.it" className="text-gray-300 hover:text-primary transition-colors">
              ...
              <p className="flex items-center">
                ...
                <a href="tel:+393331234567" className="text-gray-300 hover:text-primary transition-colors">
                  +39 02 8295 9857
                </a>
              </p>
              <p className="flex items-center">
                ...
                <span className="text-gray-300">Via Monte di Pietà, 21<br />20121 Milano MI</span>
              </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-gray-400">
            © 2025 Sales on Demand S.r.l. Tutti i diritti riservati.
          </div>
