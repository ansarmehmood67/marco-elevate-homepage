...
const AboutMarcoSection = () => {
  return (
    <section className="px-4 lg:px-8 bg-gray-50 relative overflow-hidden" style={{ height: '700px' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto h-full">
        ...
        <div className="flex lg:hidden flex-col h-full py-6">
          {/* Mobile Marco Image - Top */}
          ...
          <div className="px-4 text-center">
            ...
            <p className="text-base mb-6 leading-relaxed text-gray-700 max-w-md mx-auto">
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              <div className="bg-white rounded-xl p-3 shadow-lg border border-gray-100">
                ...
                <div className="text-xs font-medium text-gray-600">Aziende Clienti</div>
              </div>
              <div className="bg-white rounded-xl p-3 shadow-lg border border-gray-100">
                <div className="text-xl font-bold text-primary">15+</div>
                <div className="text-xs font-medium text-gray-600">Anni Esperienza</div>
              </div>
              <div className="bg-white rounded-xl p-3 shadow-lg border border-gray-100">
                <div className="text-xl font-bold text-primary">95%</div>
                <div className="text-xs font-medium text-gray-600">Tasso di Successo</div>
              </div>
            </div>
