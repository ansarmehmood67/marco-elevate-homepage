...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    video.src = "https://res.cloudinary.com/dsergeqc9/video/upload/v1758129844/salesondemand_hero_mze6vo.mp4";
    video.load();
        ...
        <div className="relative min-h-[85vh] lg:min-h-[90vh] rounded-3xl overflow-hidden border border-gray-800/30 shadow-2xl bg-black">
          ...
          <div className="absolute inset-0">
            ...
            <video
              ...
              playsInline
              preload="metadata"
              poster="https://res.cloudinary.com/dsergeqc9/image/upload/f_auto,q_auto,w_1200/v1758129844/salesondemand_hero_poster.jpg"
          ...
          <div ref={ref} className="absolute inset-0 flex flex-col justify-center lg:justify-center p-4 sm:p-6 lg:p-12 z-20">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-8">
              ...
              <div className={`relative w-full sm:w-80 lg:w-80 h-48 rounded-xl overflow-hidden shadow-2xl border-2 border-white/20 backdrop-blur-sm lg:flex-shrink-0 transition-all duration-600 ease-out delay-800 ${
                ...
                <LazyYouTubeEmbed
                  videoId="ZocHP6N9Aig"
                  title="Demo Video - Sales on Demand"
