      ...
      <div className="container mx-auto px-6 py-20 lg:py-32 relative z-10">
        ...
        <div className="mb-16 px-4 relative">
          ...
          <div className="absolute top-0 right-4 flex space-x-2 z-20">
            <button
              onClick={prevSlide}
              className={`group flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 backdrop-blur-sm ${
                isDark 
                  ? 'bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/30 text-white' 
                  : 'bg-white/80 hover:bg-white/90 border border-slate-200/50 hover:border-slate-300/60 text-slate-700 shadow-lg'
              }`}
            >
