        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className={`backdrop-blur-xl rounded-3xl p-10 border transition-all duration-500 ${
            ...
            <Button 
              variant="premium" 
              size="lg" 
              className="group relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 hover:from-blue-500 hover:via-blue-400 hover:to-blue-500 text-white font-semibold px-10 py-3 text-base rounded-xl shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300"
            >
