  ...
  return (
    <section className="relative overflow-hidden px-0 pt-8 md:pt-16 pb-0 md:pb-16 min-h-[100dvh] md:min-h-[80vh]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:hidden min-h-[100dvh] flex flex-col">
        ...
        {/* Image Section (40% of viewport, image touches bottom) */}
      ...
      <img
        ...
        className="
          ...
          max-w-[650px] xl:max-w-[700px] max-h-[88vh]
          object-contain drop-shadow-[0_24px_60px_rgba(0,0,0,0.35)]
          pointer-events-none select-none z-[7]
        "
      />
