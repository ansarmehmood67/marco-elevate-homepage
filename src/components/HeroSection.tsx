      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative min-h-[85vh] rounded-3xl overflow-hidden border border-gradient-to-r from-gray-800/40 via-primary/20 to-gray-800/40 shadow-2xl bg-black/40 backdrop-blur-md">
          ...
          <div className="absolute bottom-12 left-12 max-w-2xl z-20">
            ...
            {/* Enhanced typography with consistent design system */}
            <h1 className="text-5xl lg:text-7xl font-bold leading-[1.1] mb-10 relative">
              <span className="block mb-3 text-white drop-shadow-2xl tracking-tight">
                Esternalizza
              </span>
              <span className="block mb-3 text-primary font-bold tracking-tight">
                vendite e marketing:
              </span>
              <span className="block text-white drop-shadow-2xl tracking-tight">
                cresci
                <span className="text-primary-glow font-bold ml-4">
                  senza pensieri
                </span>
              </span>
            ...
            <div className="relative mb-10">
              <p className="text-xl lg:text-2xl text-white/95 leading-relaxed backdrop-blur-xl bg-gradient-to-r from-black/30 via-black/20 to-black/30 rounded-2xl px-6 py-4 border border-white/10 shadow-2xl">
