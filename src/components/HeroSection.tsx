...
const HeroSection = () => {
  ...
  return (
    <section className="pt-24 pb-6 px-0 bg-black relative overflow-hidden">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative min-h-[95vh] sm:min-h-[90vh] lg:min-h-[85vh] rounded-3xl overflow-hidden border border-gradient-to-r from-gray-800/40 via-primary/20 to-gray-800/40 shadow-2xl bg-black/40 backdrop-blur-md">
          {/* Background Video */}
          <video
            autoPlay
            muted
